...
public class FlightConsts {
    ...
    public static final String UNABLE_TO_CALCULATE_PRICE = "Unable to calculate tax";

    public static final double TAX_AV_CIVILE_FR = 4.4;

    public static final double TAX_AV_CIVILE_OTHER = 7.9;

    public static final double SECURITY_TAX_MAX = 9.5;

    public static final double REDEVANCE_PASSENGER_MAX = 13.0;

    public static final double SECURITY_TAX = 3.0;

    public static final double REDEVANCE_PASSENGER = 2.6;
